...
const LoginPage: React.FC = () => {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      console.error("获取Google认证URL失败", error);
      toast.error('Google登录暂时不可用，请稍后再试', {
        position: "top-left",
      });
    } finally {
      ...
      <div className="mt-8">
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white text-gray-500">快速登录</span>
          </div>
        </div>
        ...
        <div className="mt-6 flex justify-center space-x-4">
          ...
          <button
            ...
            className="flex justify-center items-center p-3 rounded-full shadow-sm bg-gray-800 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <button
            ...
            className="flex justify-center items-center p-3 rounded-full shadow-sm bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 transition-all border border-gray-300 disabled:opacity-50 disabled:cursor-not-allowed"
